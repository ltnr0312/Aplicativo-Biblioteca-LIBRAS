...
transportes_imgs = { "Avião": get_image_base64("transportes/aviao.png", is_image=True),
...
def menu_principal():
    ...
    with col1:
        ...
        if st.button("Clique para Profissões", key="profissoes"):
            st.session_state.pagina_atual = 'profissoes'  # Atualiza o estado aqui
    with col2:
        ...
        if st.button("Clique para Transportes", key="transportes"):
            st.session_state.pagina_atual = 'transportes'  # Atualiza o estado aqui

# Gerenciar as páginas
if 'pagina_atual' not in st.session_state:
    st.session_state.pagina_atual = 'menu'  # Estado inicial
